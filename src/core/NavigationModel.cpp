...
void NavigationModel::rebuildItems() {
    ...
    m_items.append({
        u"MAIN"_s,
        tr("Dictate"),
        u"qrc:/qt/qml/QTranscribe/assets/icons/mic.svg"_s,
        u"dictate"_s,
        true
    });
    ...
    m_items.append({
        u"MAIN"_s,
        tr("History"),
        u"qrc:/qt/qml/QTranscribe/assets/icons/history.svg"_s,
        u"history"_s,
        false
    });
    ...
    if (m_isOnline) {
        m_items.append({
            u"MAIN"_s,
            tr("Cloud Usage"),
            u"qrc:/qt/qml/QTranscribe/assets/icons/activity.svg"_s,
            u"cloudUsage"_s,
            false
        });
    }
    ...
    m_items.append({
        u"PREFERENCES"_s,
        tr("Dictation"),
        u"qrc:/qt/qml/QTranscribe/assets/icons/speech.svg"_s,
        m_isOnline ? u"online"_s : u"offline"_s,
        true
    });
    ...
    m_items.append({
        u"PREFERENCES"_s,
        tr("System & Audio"),
        u"qrc:/qt/qml/QTranscribe/assets/icons/keyboard.svg"_s,
        u"system"_s,
        false
    });
    ...
    m_items.append({
        u"INFO"_s,
        tr("About"),
        u"qrc:/qt/qml/QTranscribe/assets/icons/info.svg"_s,
        u"about"_s,
        true
    });
    ...
    m_items.append({
        u"INFO"_s,
        tr("License"),
        u"qrc:/qt/qml/QTranscribe/assets/icons/license.svg"_s,
        u"license"_s,
        false
    });
